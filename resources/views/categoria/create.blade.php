...
<div id="addCategoryModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 hidden transition-opacity duration-300 ease-in-out">
    <div class="bg-white rounded-xl shadow-2xl overflow-hidden w-full max-w-md mx-4 my-8 border-t-4 border-green-500 animate-[fadeIn_0.3s_ease-out]">
        ...
        <form id="addCategoryForm" action="{{ route('categorias.store') }}" method="POST" class="px-6 py-4">
            @csrf
            ...
            <div class="mt-8 pt-4 border-t border-gray-100 flex justify-end space-x-3">
                <button type="button"
                    class="px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 close-modal">
